...
public final class RDFModel {
    ...
    // URI - Instances
    public static final String unitURI = "http://encyclopediasemantica.org/semantic/elements/units/";
    public static final String dimensionURI = "http://encyclopediasemantica.org/semantic/elements/dimensions/";
    public static final String prefixURI = "http://encyclopediasemantica.org/semantic/elements/prefixes/";

    // URI - OWL Schema
    public static final String schemaURI = "http://encyclopediasemantica.org/semantic/schema/units/";
