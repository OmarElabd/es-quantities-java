...
public class QuantityProductTests {
    @Test
    @DisplayName("5m * 5 = 25m")
    public void testProductIntInt() throws ParseException {
        Quantity actual = Quantity.of(5, metre).multiply(Quantity.of(5, metre));;

        assertEquals(25, actual.value);
        assertTrue(actual.unit.equivalentTo(SIDerivedUnits.squareMetre));
    }
    ...
    public void testProductIntDouble() throws ParseException {
        ...
        assertEquals(actual.unit, SIDerivedUnits.squareMetre);
    }
    ...
    public void testProductLongLong() throws ParseException {
        Quantity multiplicand = Quantity.of(5L, metre);
        Quantity actual = multiplicand.multiply(Quantity.of(5L, metre));
        assertEquals(25L, actual.value);
        assertEquals(actual.unit, SIDerivedUnits.squareMetre);
    }
    ...
    public void testProductBigDecimalInt() {
